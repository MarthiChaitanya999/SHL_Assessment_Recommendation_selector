...
from scraper import scrape_shl_catalog, save_to_csv
import time
...
def load_or_scrape_data():
    ...
    filename = "data_shl_assessments.csv"
...
def main():
    ...
    st.markdown("---")
    st.markdown("📎 [GitHub](https://github.com/MarthiChaitanya999) | 🤖 Powered by FastAPI, Streamlit, and SentenceTransformers")
    st.caption("© 2025 Chaitanya Marthi | SHL GenAI Assignment")
